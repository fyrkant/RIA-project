...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    router = __webpack_require__(212);

	ReactDOM.render(React.createElement(Router, { routes: router }), document.getElementById("container"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewAdvertForm = React.createClass({
	    displayName: "NewAdvertForm",

	    handleChange: function handleChange() {
	        this.props.onUserInput(this.refs.titleText.value, this.refs.descriptionText.value, this.refs.nameText.value);
	    },
	...
	var RegisterAdvertPage = React.createClass({
	    displayName: "RegisterAdvertPage",
	    ...
	    handleUserInput: function handleUserInput(titleText, descriptionText, nameText) {
	        this.setState({
	            titleText: titleText,
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            null,
	            React.createElement(NewAdvertForm, {
	                onUserInput: this.handleUserInput,
	                titleText: this.state.titleText,
	                descriptionText: this.state.descriptionText,
	                nameText: this.state.nameText
	            }),
	            React.createElement(PreviewAdvert, {
	                titleText: this.state.titleText,
	                descriptionText: this.state.descriptionText,
	                nameText: this.state.nameText
	            })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegisterUserForm = React.createClass({
	    ...
	    handleSubmit: function handleSubmit(e) {
	        ...
	        var emailToSave = this.refs.emailInput.value;
	        var passwordToSave = this.refs.passwordInput.value;

	        this.props.onSave(emailToSave, passwordToSave);
	    },
	    render: function render() {
	        return React.createElement(
	            'form',
